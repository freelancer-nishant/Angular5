...
export class EnrollmentAndAttendanceComponentDailyAttendance implements OnInit {
    ...
    ngOnInit() {
        this.enrollmentAttendanceComponent.selectedOption = 'Daily Attendance';
    }

    submit() {
        let responseResult: ResponseResult;
        this.enrollmentAttendanceService.saveAttendance(this.enrollmentAttendanceComponent.filesAdded).subscribe(
