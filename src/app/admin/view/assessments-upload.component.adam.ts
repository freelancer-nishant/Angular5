...
export class AssessmentUploadsComponentAdam implements OnInit {
    ...
    ngOnInit() {
        this.assessmentUploadsComponent.selectedOption = 'LGL - ADAM';
    }

    submit() {
        let responseResult: ResponseResult;
        this.assessmentService.saveADAM(this.assessmentUploadsComponent.filesAdded).subscribe((result: any) => responseResult = result,
            (error: any) => {
